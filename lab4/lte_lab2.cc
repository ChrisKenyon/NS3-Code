...
NS_LOG_COMPONENT_DEFINE ("Lte_Handover");
...
main (int argc, char *argv[])
{
  ...
  uint16_t numberOfEnbs = 4; //based on slides
  uint16_t numBearersPerUe = 1;
  double distance = 500.0; // m
  double yForUe = 200.0;   // m
  double speed = 15;       // m/s
  double simTime = (double)(numberOfEnbs + 1) * distance / speed; // 2500 m / 15 m/s = 166.66 secs
